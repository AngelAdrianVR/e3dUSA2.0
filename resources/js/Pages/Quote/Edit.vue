                    ...
                    <form @submit.prevent="update">
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-4 gap-3 items-start">
                                ...
                                <div v-if="!currentProduct.is_custom" class="lg:col-span-full bg-white dark:bg-slate-900/50 p-4 rounded-lg border border-gray-200 dark:border-slate-700 shadow-sm mb-3">
                                    ...
                                    <div v-if="selectedBaseProductId && availableVariants.length" class="animate-fade-in-down">
                                        ...
                                        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 max-h-96 overflow-auto">
                                ...
                                <li v-for="(product, index) in form.products" :key="index" class="flex justify-between items-center p-3 rounded-md transition-colors"
                                    ...
                                    <div class="flex items-center space-x-4">
                                        ...
                                        <span class="text-sm text-gray-800 dark:text-gray-200">
                                            ...
                                            <!-- Mostrar justificación si hay precio bajo -->
                        ...
                        <div v-if="hasLowPrices" class="col-span-full mt-4 p-5 bg-amber-50 border border-amber-300 rounded-lg dark:bg-amber-900/20 dark:border-amber-700 shadow-sm transition-all">
                            <div class="flex items-center text-amber-700 dark:text-amber-400 mb-3">
                                ...
                                <p class="font-bold">Hay productos por debajo del precio establecido. La cotización requerirá autorización después de ser actualizada.</p>
                            </div>
                        </div>
...
export default {
    ...
    computed: {
        ...
        isAddProductDisabled() {
            ...
            // Si tiene precio bajo, requiere la justificación obligatoriamente.
    ...
    methods: {
        ...
        async fetchCatalogProducts() {
            // Usar router.reload para recargar de la base de datos y traer
            // padres + variantes de forma correcta, como se hace en Create
            router.reload({
        ...
        handleBranchChange(branchId) {
            // Lógica para cambiar contactos (puede ser personalizada si se maneja aquí)
    ...
    created() { 
        ...
        this.form.has_low_price = Boolean(this.quote.has_low_price);
        ...
        this.form.products = qProducts.map(qp => {
            ...
            return {
                ...
                has_low_price: Boolean(qp.has_low_price),
                low_price_reason: qp.low_price_reason || '',
                notes: qp.notes || '',
