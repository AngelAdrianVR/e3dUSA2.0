...
export default {
    data() {
        // Inicializar el formulario con los datos del prop
        const form = useForm({
            ...
            // Mapear los items para que coincidan con la estructura del formulario
            items: this.sampleTracking.items.map(item => ({
                ...
                notes: item.notes || '',
                media: [], // Media no se puede pre-cargar, se deja vacío para nuevos archivos
            })),
        });
    ...
    methods: {
        update() {
            // Usamos _method: 'put' porque HTML no soporta PUT en formularios nativos
        ...
        // Método para inicializar los contactos disponibles al cargar
        initializeContacts() {
