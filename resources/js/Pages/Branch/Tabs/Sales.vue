<template>
    <p class="text-xs mb-1 ml-3">Últimas 20 ventas</p>
    <div v-if="sales.length">
        <el-table 
            ...
            <el-table-column v-if="$page.props.auth.user.permissions.includes('Ver utilidad ventas')" label="Utilidad" width="100">
                <template #default="scope">
                    <el-tooltip v-if="scope.row.type === 'venta' && scope.row.utility_data" placement="right" effect="dark">
                        <template #content>
                            <div class="text-xs">
                    ...
                    <p v-else class="text-center text-xs text-gray-400">N/A</p>
                </template>
            </el-table-column>
