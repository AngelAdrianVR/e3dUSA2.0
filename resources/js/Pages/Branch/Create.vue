                ...
                <div class="bg-white dark:bg-slate-800 overflow-hidden shadow-xl sm:rounded-lg p-6 md:p-8">
                    ...
                    <form @submit.prevent="store">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-5 gap-y-4">
                            ...
                            <TextInput label="Número de Cliente" v-model="form.client_number" type="text" :error="form.errors.client_number" placeholder="Ej. C001" />
                            <TextInput label="Nombre/Alias*" v-model="form.name" type="text" :error="form.errors.name" placeholder="Nombre de empresa/sucursal" />
                            ...
                            <TextInput label="Grupo" v-model="form.group_name" type="text" :error="form.errors.group_name" placeholder="Ej. Andrade, Autocom (Opcional)" />
