    ...
    <AppLayout :title="`Solicitud: ${designOrder.order_title}`">
        ...
        <header class="flex flex-col sm:flex-row justify-between items-center space-y-3 sm:space-y-0 pb-4 border-b dark:border-gray-500">
            ...
            <div class="flex items-center space-x-2 dark:text-white mr-4">
                ...
                <el-tooltip v-if="designOrder.status === 'Terminada' && $page.props.auth.user.permissions.includes('Crear formatos de autorizacion de diseño')" content="Crear formato de autorizacion de diseño" placement="top">
                    <button @click="''" class="size-9 flex items-center justify-center rounded-lg bg-gray-200 hover:bg-gray-300 dark:bg-slate-800 dark:hover:bg-slate-700 transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
