    ...
    <ActionSection>
        ...
        <template #content>
            <div class="max-w-xl text-sm text-gray-600 dark:text-gray-300">
                Si es necesario, puede cerrar sesión en todas sus demás sesiones de navegador en todos sus dispositivos. A continuación, se enumeran algunas de sus sesiones recientes; sin embargo, esta lista puede no ser exhaustiva. Si considera que su cuenta ha sido vulnerada, también debería actualizar su contraseña.
            </div>

            <!-- Other Sesiones de navegador -->
            ...
            <div class="flex items-center mt-5">
                <PrimaryButton @click="confirmLogout">
                    Cerrar sesión Otras Sesiones de navegador
                </PrimaryButton>
            ...
            <DialogModal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    Please enter your password to confirm you would like to log out of your other Sesiones de navegador across all of your devices.
