...
export function useNavigation(route) {
    ...
    const menus = computed(() => [
        ...
        },
        {
            ...
            active: route().current('suppliers.*') || route().current('purchases.*') || route().current('stock-projection.*') || route().current('stock-reposition.*'),
            options: [
                ...
                { label: 'Proyección de compras', route: 'stock-projection.index', active: route().current('stock-projection.*'), show: can('Ver proyección de compras'), },
                { label: 'Productos con bajo stock', route: 'stock-reposition.index', active: route().current('stock-reposition.*'), show: can('Ver productos con bajo stock'), },
            ],
            dropdown: true,
            show: can('Ver proveedores') || can('Ver ordenes de compra') || can('Ver proyección de compras') || can('Ver productos con bajo stock')
        },
        {
            label: 'Logistica',
        ...
        },
        {
            ...
            active: route().current('projects.*') || route().current('pms.*'),
            options: [
                {
                    label: 'Proyectos',
            ...
            dropdown: true,
            show: can('Ver proyectos') || can('Ver pms')
        },
        {
            label: 'Más',
