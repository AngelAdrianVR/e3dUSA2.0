  ...
  <div class="w-full font-sans">
    ...
    <div
      ...
      { 'opacity-60 cursor-not-allowed': isLimitReached },
        ...
        isDragging
          ? 'border-primary bg-primary/10 dark:bg-slate-800'
          : 'border-gray-300 dark:border-gray-600 hover:border-primary/70 dark:hover:border-primary/80 hover:bg-gray-50 dark:hover:bg-slate-800/60',
      ]"
    >
      <input
        type="file"
      ...
      <div class="flex flex-col items-center justify-center p-6 text-center">
        ...
        <p class="mb-2 text-sm">
          <span class="font-semibold text-primary dark:text-primary/90">Haz clic para cargar</span> o arrastra y suelta
        </p>
