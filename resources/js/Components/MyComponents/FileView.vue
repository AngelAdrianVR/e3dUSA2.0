<template>
    <el-tooltip :disabled="!file.original_url" placement="top" effect="dark" raw-content>
        ...
        <div @click="openFile"
            class="group flex items-center space-x-2 border border-gray-400 dark:border-zinc-700 dark:bg-zinc-800/50 dark:text-white rounded-lg py-2 px-4 cursor-pointer transition-all duration-300 ease-in-out hover:border-secondary dark:hover:border-secondary hover:shadow-lg hover:shadow-secondary/20 dark:hover:shadow-secondary/10 hover:-translate-y-1">
