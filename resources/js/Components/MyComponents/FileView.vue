<template>
    <div @click="openFile"
        class="flex space-x-2 border border-gray-400 dark:border-zinc-600 dark:text-white dark:border-grayD9 rounded-md p-2 cursor-pointer hover:border-primary dark:hover:border-primary transition duration-200 ease-linear">
