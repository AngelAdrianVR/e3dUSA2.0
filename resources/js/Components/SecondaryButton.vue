...
defineProps({
    ...
    // Nueva propiedad para controlar el estado de carga
    loading: {
        type: Boolean,
        default: false,
    },
...
<template>
    <button 
        ...
        :disabled="loading"
        class="
            relative inline-flex items-center justify-center px-7 py-2 overflow-hidden
            bg-primary border border-transparent rounded-xl 
        ...
        <span 
            ...
            :class="{ '-translate-x-3': loading }"
        >
            <slot />
        </span>

        <!-- Contenedor para el spinner, posicionado absolutamente a la derecha -->
        <div 
            class="
